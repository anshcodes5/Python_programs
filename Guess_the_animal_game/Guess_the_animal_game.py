...
def game():
    ...
    def start():
        ...
        animal = animals[category_num][animal_num]
        ...
        #Converting the animal name to lowercase to match the casing with the user's input
        ...
        def prompt():
            ...
            if user_answer == animal_low:
                ...
                if user_replay == "re":
                    ...
                    user_replay = input("Invalid input\nType a valid input.")
                    if user_replay == "re":
                        start()
                    elif user_replay == "q":
                        input("Enter anything to close the game.\n")
                ...
                if user_retry == "r":
                    ...
                    user_retry = input("Invalid input\nType a valid input.")
                    if user_retry == "r":
                        prompt()
                    elif user_retry == "re":
                        start()
    ...
    if user_input_start == "s":
        ...
        if user_replay == "re":
            ...
            if user_replay == "re":
                ...
                print("Thank you for playing.")
#calling the main game program "start()" function to start the game program.
